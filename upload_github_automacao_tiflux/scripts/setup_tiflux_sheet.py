...
STATUS_CELL = "T2"
IMPEDIMENTO_OPTIONS = [
    "Nao disponivel - Fatura do mes nao esta disponivel.",
    "Sem acesso no portal da operadora",
    "Servico vazio ou duplicado por fatura",
    "Aguardando arquivo da operadora",
]
TRATATIVAS_OPTIONS = [
    "Acompanhar devolutiva - Operadora",
    "Validacao de Ausencia de trafego",
    "Fat manual operadora nao disponibiliza AE",
    "Aguardando validacao interna",
]
ESTAGIO_OPTIONS = [
    "Pendente",
    "Em andamento",
